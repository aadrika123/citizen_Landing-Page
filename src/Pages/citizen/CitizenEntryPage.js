...
function CitizenEntryPage(props) {
    ...
    return (
        <>
            <div class="flex flex-row p-6 py-20">
                <div class="basis-1/4 justify-center items-center text-center ">
                    <h3 class=" text-gray-600 font-sans md:text-lg sm:text-sm  lg:text-4xl mt-6">Welcome,<br /> {citizenName?.name}!</h3>
                </div>
                ...
                <div class="basis-1/4   ">
                    <div className='bg-blue-400 w-9 h-9 rounded-full p-1 mt-2 ml-8 animate-bounce border border-slate-200'>
                    ...
                    <div className='bg-yellow-400 w-9 h-9 rounded-full p-1 ml-24 -mt-14 animate-bounce text-white  border border-slate-200'>
                    ...
                    <div className='bg-green-400 w-9 h-9 rounded-full p-1 ml-36 animate-bounce text-white border border-slate-200'>
