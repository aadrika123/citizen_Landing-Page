...
function LicenseDetails(props) {
    ...
    const validationSchema = yup.object({
        ...
        paymentMode: yup.string().when('hoardingStatus', {
            is: 'yes',
            then: yup.string().required('Field is required')
        }).min(1, 'enter minimum ').max(10, 'Enter max 10 digit'),

        bankName: yup.string().when("paymentMode", { is: "DD", then: yup.string().required('Bank Name is required') }),
    ...
    const handleOnChange = (event) => {
        ...
        { name === 'paymentMode' && (value == 'CHEQUE' || value == 'DD') ? setpaymentToggelStatus(true) : setpaymentToggelStatus(false) }
    };
                    ...
                    <div className='relative -top-6  '>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-1'>
                            <div className={`${inputContainerStyle}`}>
                                ...
                                <input type="date" name="chequeNo" className={`${commonInputStyle} pointer-events-none bg-gray-100 `} value={formik.values.totalCharge} onChange={formik.handleChange} />
                            ...
                            <div className={`${inputContainerStyle}`}>
                                ...
                                <input type="number" name="chequeNo" className={`${commonInputStyle} pointer-events-none bg-gray-100 `} value={formik.values.totalCharge} onChange={formik.handleChange} />
                            ...
                            <div className={`${inputContainerStyle}`}>
                                ...
                                <input type="text" name="bankName" className={`${commonInputStyle} pointer-events-none bg-gray-100 `} value={formik.values.bankName} onChange={formik.handleChange} />
                            ...
                            <div className={`${inputContainerStyle}`}>
                                ...
                                <input type="text" name="branchName" className={`${commonInputStyle} pointer-events-none bg-gray-100 `} value={formik.values.totalCharge} onChange={formik.handleChange} />
