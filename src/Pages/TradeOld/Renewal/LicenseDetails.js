...
function LicenseDetails(props) {
    ...
    console.log('props values in license charge :', props.values);
    ...
    const getLicenseCharge = (value) => {
        console.log("calculation application type", convertApplicationTypeToString(props.values?.applicationType));
        showLoader(true)
        let data = [];
