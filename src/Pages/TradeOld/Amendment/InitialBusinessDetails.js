...
function InitialBusinessDetails(props) {
    ...
    const validationSchema = yup.object(applicationType == 1 ? {
    ...
    const initialValues = applicationType == 1 ? {
        ...
        applicationType: props.values.licenseData.licenceDtl.application_type,
        firmType:props.values.licenseData.licenceDtl.firm_type_id,
        ownershipType: props.values.licenseData.licenceDtl.ownership_type_id,
        licenseNo: props.values.licenseData.licenceDtl.license_no,
        categroyTypeId: props.values.licenseData.licenceDtl.category_type_id
    }
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3">
                                <div className={`${inputContainerStyle}`}>
                                    ...
                                    <div className="border px-4 py-1.5 bg-gray-400 rounded-lg">{props.values.licenseData.licenceDtl.application_type}</div>
                                </div>
                                <div className={`${inputContainerStyle}`}>
                                    <label className={`${inputLabelStyle} text-xs`}>
                                    ...
                                    <div className="border px-4 py-1.5 bg-gray-400 rounded-lg"> {props.values.licenseData.licenceDtl.license_no} </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3">
                                <div className={`${inputContainerStyle}`}>
                                    ...
                                    <div className="border px-4 py-1.5 bg-gray-400 rounded-lg">{props.values.licenseData.licenceDtl.firm_type}</div>
                                ...
                                <div className={`${inputContainerStyle}`}>
                                    ...
                                    <div className="border px-4 py-1.5 bg-gray-400 rounded-lg">{props.values.licenseData.licenceDtl.ownership_type_id}</div>
