            ...
            <div className='grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 container mx-auto p-2'>
                <div className='col-span-9 '>
                    <div className='bg-[#f3f5fa]'>
                        ...
                        <p className='p-2 text-center text-[#37517e]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis eum voluptas sapiente. Veritatis a ad officia alias illum eligendi temporibus laudantium nisi ex eveniet nemo, corporis id voluptas neque excepturi?</p>
                        <div>
                            <Carousel>
                ...
                <div className='col-span-3 border-4 divide-y divide-[#37517e] p-2'>
                    <h1 className='text-center font-normal font-sans text-xl text-[#37517e] '>QUICK LINK</h1>
