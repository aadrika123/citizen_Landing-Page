                    ...
                    <div className='bg-white shadow-xl md:m-5'>
                        ...
                        <div className="md:inline-block min-w-full overflow-hidden hidden">
                            ...
                            <div className='my-5 flex justify-center'>
                                <div className='mx-2'><button onClick={handleBackBtn} className='bg-blue-600 hover:bg-blue-700 px-5 py-2 shadow-xl rounded-md text-white text-base'>Back</button></div>
